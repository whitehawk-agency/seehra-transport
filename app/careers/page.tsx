      ...
      <div id="jobs" className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-gray-200 lg:sticky lg:top-24 overflow-hidden">
              <button
                onClick={() => setFiltersOpen(o => !o)}
                className="w-full flex items-center justify-between px-5 py-4 text-left"
                aria-expanded={filtersOpen}>
                <span className="font-bold text-sm text-gray-900 flex items-center gap-2">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className="text-[#f7680b]"><line x1="4" y1="6" x2="20" y2="6"/><line x1="7" y1="12" x2="17" y2="12"/><line x1="10" y1="18" x2="14" y2="18"/></svg>
                  Filter Jobs
                  {(filterType !== "All" || filterLocation !== "All") && (
                    <span className="ml-1 w-2 h-2 rounded-full bg-[#f7680b]" />
                  )}
                </span>
            ...
            {loading ? (
              ...
              jobs.length === 0 ? (
                <div className="bg-white rounded-2xl border border-gray-200 p-10 sm:p-12 text-center">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: "linear-gradient(135deg,#e62b1e,#f7680b)" }}>
                    <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
                  </div>
                  <h3 className="font-extrabold text-gray-900 text-lg mb-2">No current openings</h3>
                  <p className="text-gray-500 text-sm mb-6 max-w-sm mx-auto">We don't have any vacancies listed right now, but new roles come up regularly. Check our Indeed and LinkedIn pages, or get in touch and we'll keep you in mind.</p>
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href={indeedCompanyUrl} target="_blank" rel="noopener noreferrer" className="text-white text-sm font-bold px-6 py-3 rounded-full transition-all hover:opacity-90" style={{ background: "linear-gradient(135deg,#e62b1e,#f7680b)" }}>View jobs on Indeed →</a>
                    <Link href="/contact" className="border border-gray-200 text-gray-700 text-sm font-bold px-6 py-3 rounded-full hover:border-[#f7680b] hover:text-[#f7680b] transition-colors">Contact us</Link>
                  </div>
                </div>
              ) : (
                <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center">
                  ...
                  <h3 className="font-bold text-gray-900 mb-1">No jobs match your filters</h3>
