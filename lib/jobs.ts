// ── In-memory job store (persists via JSON file in /tmp in prod)
// For production replace with a database like PlanetScale/Supabase/Vercel KV
...
export interface Application {
  ...
  availability: string;
  coverLetter: string;
  source: "website" | "indeed" | "linkedin";
...
export const DEFAULT_JOBS: Job[] = [
  {
    ...
    requirements: [
      "Valid UK driving licence (held 1+ year, max 6 points)",
      "Smartphone for route app",
      "DBS check (we arrange and pay)",
      "Drugs & alcohol test (we arrange and pay)",
      "Ability to work independently",
      "Customer-focused attitude",
    ],
    responsibilities: [
      "Complete daily multi-drop delivery routes efficiently",
      "Provide excellent customer service at every delivery",
      "Use our route app to manage deliveries",
      "Collect proof of delivery at each stop",
      "Report any issues to the logistics team promptly",
    ],
    benefits: [
      ...
      "Bring your own van or rent from us (low deposit)",
    ],
    status: "active",
  ...
  },
  {
    ...
    requirements: [
      "Valid UK driving licence (held 1+ year, max 6 points)",
      "Own van or ability to rent from us",
      "Smartphone for route app",
      "DBS check required (we pay)",
      "Reliable and punctual",
    ],
    responsibilities: [
      "Manage daily delivery routes across East Midlands",
      "Deliver to residential and commercial addresses",
      "Maintain high standards of customer service",
      "Complete proof of delivery for every parcel",
    ],
    benefits: [
      "Weekly payments — every week without fail",
      "Fuel allowance on top of day rate",
      "Full paid training provided",
      "Choose your working days",
      "Low-deposit van rental available",
  ...
  },
  {
    ...
    requirements: [
      "Previous logistics or transport coordination experience",
    ...
    responsibilities: [
      "Plan and optimise daily delivery routes",
      "Communicate with drivers throughout the day",
      "Handle client queries and delivery updates",
      "Maintain accurate records and reporting",
      "Coordinate with warehouse team on collections",
    ],
    benefits: [
